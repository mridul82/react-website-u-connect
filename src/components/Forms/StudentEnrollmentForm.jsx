...
<Link className="bg-[#539165] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded m-4 items-center justify-center" to="/add-student-profile">
       Find a Tutor
       </Link>
</button>
    ...
    <h2 className=' text-lg font-bold text-[#539165] mb-5'>Register for Test Series</h2>
    <form >
