      ...
      <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
        ...
        <div className="p-4 py-6 text-white bg-red-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
          ...
          <p className="flex flex-col items-center justify-center mt-10 text-center">
            ...
            <button className="bg-white text-red-400 hover:bg-red-400 hover:text-white hover:shadow-lg p-2 rounded-lg">
            <Link to={"/signup"} >
          Register
           </Link>
            </button>
          ...
          <form action="#" className="flex flex-col space-y-5">
            ...
            <div>
              <button
                type="submit"
                onClick={handleLogin}
                className="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-red-400 rounded-md shadow hover:bg-red-600 focus:outline-none focus:ring-blue-200 focus:ring-4"
              >
                Log in
              </button>
            </div>
